...
/* รอบจับเวลาสำหรับไว้รองรับการทดสอบ ณ ปัจจุบันได้เลยนะ เพราะหากว่าจะรอว่าทุกเทียงคืนจาก startTelemedTimer() ให้ทำ มันจะไม่ได้ทดสอบกันละคราวนี้ ตั้งเวลาTimer สั้น ยาว เอาตามต้องการนะ */
